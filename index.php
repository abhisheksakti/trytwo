...
<div ID="TOP" STYLE="background-color:green;height:50px;">
<h1><font color="white">WEL COME EVERY ONE (THIS IS A SIMPLE TIC TAC GAME)</H1>
<P><font color="white">YOU TRY TO WIN HERE ONCE</P>
<P><font color="white">IF YOU WON ,TEXT ME IN WHATSAPP<font color="pink">(9778802345)</p>
<p> <font color="white">I HAVE A SPECIAL PRIZE FOR YOU</P> 

</div>
   
<FORM  id="form1" NAME="tic" method="post">
...
<INPUT TYPE="button" NAME="sqr9" class="tictac" value="     " onClick="if(document.tic.sqr9.value == '     ' && turn == 0 && mode == 1) {document.tic.sqr9.value = ' X '; sqr9T = 1; turn = 1; vari(); check();} else if(document.tic.sqr9.value == '     ' && turn == 1 && mode == 2) {document.tic.sqr9.value = ' X '; sqr9T = 1; turn = 0; vari(); player1Check()} else if(document.tic.sqr9.value == '     ' && turn == 0 && mode == 2) {document.tic.sqr9.value = ' O '; sqr9T = 1; turn = 1; vari(); player1Check()} drawCheck()">
		      ...
		      <div id="pageend2" style="position:absolute;bottom:2px;background-color:black;width:1332px;">
		        <div id="copyright1">
				   <h6  style="color:white;font-size:20px;position:relative;left:30px;"> use of this sight is goverend by our Terms and Conditions </h6>
				</div>
		        <div id="copyright2">
				   <h6  style="color:white;font-size:20px;position:relative;left:30px;">    copy right@ 2016-2020 all rights reserve for Abhishek Sahu(201610389) </h6>
				</div>
